...
Wiz, Saviynt 등 IT 보안 솔루션 학습 영상에 최적화되어 있습니다.
...
### 5. nircmd.exe 다운로드 (최초 1회)

https://www.nirsoft.net/utils/nircmd.html 하단 **Download NirCmd 64-bit** 클릭
압축 해제 후 `nircmd.exe` 를 프로젝트 폴더에 복사.
